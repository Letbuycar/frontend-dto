 ...
 * Read Cargos
 */
export const readCargosApiV1CargoGet = <ThrowOnError extends boolean = false>(options?: Options<ReadCargosApiV1CargoGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<ReadCargosApiV1CargoGetResponse, ReadCargosApiV1CargoGetError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/'
    });
};
 ...
 * Create New Cargo
 */
export const createNewCargoApiV1CargoPost = <ThrowOnError extends boolean = false>(options: Options<CreateNewCargoApiV1CargoPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateNewCargoApiV1CargoPostResponse, CreateNewCargoApiV1CargoPostError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/'
    });
};
 ...
 * Read Cargo
 */
export const readCargoApiV1CargoCargoIdGet = <ThrowOnError extends boolean = false>(options: Options<ReadCargoApiV1CargoCargoIdGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<ReadCargoApiV1CargoCargoIdGetResponse, ReadCargoApiV1CargoCargoIdGetError, ThrowOnError>({
        ...options,
 ...
 */
export const deleteExistingCargoApiV1CargoCargoIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteExistingCargoApiV1CargoCargoIdDeleteData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteExistingCargoApiV1CargoCargoIdDeleteResponse, DeleteExistingCargoApiV1CargoCargoIdDeleteError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/{cargo_id}/'
    });
};
 ...
 */
export const updateExistingCargoApiV1CargoCargoIdPut = <ThrowOnError extends boolean = false>(options: Options<UpdateExistingCargoApiV1CargoCargoIdPutData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateExistingCargoApiV1CargoCargoIdPutResponse, UpdateExistingCargoApiV1CargoCargoIdPutError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/{cargo_id}/'
    });
};
 ...
 * Read Cargo By Vin
 */
export const readCargoByVinApiV1CargoVinCargoVinGet = <ThrowOnError extends boolean = false>(options: Options<ReadCargoByVinApiV1CargoVinCargoVinGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<ReadCargoByVinApiV1CargoVinCargoVinGetResponse, ReadCargoByVinApiV1CargoVinCargoVinGetError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/vin/{cargo_vin}/'
    });
};
 ...
 */
export const updateExistingCargoLogistApiV1CargoLogistCargoIdPut = <ThrowOnError extends boolean = false>(options: Options<UpdateExistingCargoLogistApiV1CargoLogistCargoIdPutData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateExistingCargoLogistApiV1CargoLogistCargoIdPutResponse, UpdateExistingCargoLogistApiV1CargoLogistCargoIdPutError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/logist/{cargo_id}/'
    });
};
 ...
 * Update Existing Cargo Logist
 */
export const updateExistingCargoLogistApiV1CargoSetIsPhotoPost = <ThrowOnError extends boolean = false>(options: Options<UpdateExistingCargoLogistApiV1CargoSetIsPhotoPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<UpdateExistingCargoLogistApiV1CargoSetIsPhotoPostResponse, UpdateExistingCargoLogistApiV1CargoSetIsPhotoPostError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/set-is-photo/'
    });
};
