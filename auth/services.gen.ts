...
import type { RegisterAccountApiV1AuthPostError, RegisterAccountApiV1AuthPostResponse, SignupUserApiV1AuthSignupPostData, SignupUserApiV1AuthSignupPostError, SignupUserApiV1AuthSignupPostResponse, SigninUserApiV1AuthSigninPostData, SigninUserApiV1AuthSigninPostError, SigninUserApiV1AuthSigninPostResponse, ChangeMeApiV1AuthChangePatchData, ChangeMeApiV1AuthChangePatchError, ChangeMeApiV1AuthChangePatchResponse, GetMeApiV1AuthMeGetError, GetMeApiV1AuthMeGetResponse, ChangeUserApiV1AuthChangeUserIdPatchData, ChangeUserApiV1AuthChangeUserIdPatchError, ChangeUserApiV1AuthChangeUserIdPatchResponse, CheckUserRoleApiV1AuthCheckRoleUserIdGetData, CheckUserRoleApiV1AuthCheckRoleUserIdGetError, CheckUserRoleApiV1AuthCheckRoleUserIdGetResponse, AdminGetUsersApiV1UsersGetData, AdminGetUsersApiV1UsersGetError, AdminGetUsersApiV1UsersGetResponse, AdminGetUserApiV1UsersUserIdGetData, AdminGetUserApiV1UsersUserIdGetError, AdminGetUserApiV1UsersUserIdGetResponse, ChangeUserApiV1UsersChangeUserIdPatchData, ChangeUserApiV1UsersChangeUserIdPatchError, ChangeUserApiV1UsersChangeUserIdPatchResponse, RootGetError, RootGetResponse } from './types.gen';
 ...
 * Check User Role
 */
export const checkUserRoleApiV1AuthCheckRoleUserIdGet = <ThrowOnError extends boolean = false>(options?: Options<CheckUserRoleApiV1AuthCheckRoleUserIdGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<CheckUserRoleApiV1AuthCheckRoleUserIdGetResponse, CheckUserRoleApiV1AuthCheckRoleUserIdGetError, ThrowOnError>({
        ...options,
