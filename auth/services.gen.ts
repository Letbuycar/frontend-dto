 ...
 * Admin Get Users
 */
export const adminGetUsersApiV1UsersBrokersGet = <ThrowOnError extends boolean = false>(options?: Options<AdminGetUsersApiV1UsersBrokersGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<AdminGetUsersApiV1UsersBrokersGetResponse, AdminGetUsersApiV1UsersBrokersGetError, ThrowOnError>({
        ...options,
