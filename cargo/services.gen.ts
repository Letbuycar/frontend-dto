 ...
 * Update Existing Cargo Logist
 */
export const updateExistingCargoLogistApiV1CargoRobotHasFileAccessPost = <ThrowOnError extends boolean = false>(options: Options<UpdateExistingCargoLogistApiV1CargoRobotHasFileAccessPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<UpdateExistingCargoLogistApiV1CargoRobotHasFileAccessPostResponse, UpdateExistingCargoLogistApiV1CargoRobotHasFileAccessPostError, ThrowOnError>({
        ...options,
