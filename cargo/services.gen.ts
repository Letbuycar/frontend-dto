 ...
 * Read Cargos
 */
export const readCargosApiV1CargoGeneralGet = <ThrowOnError extends boolean = false>(options?: Options<ReadCargosApiV1CargoGeneralGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<ReadCargosApiV1CargoGeneralGetResponse, ReadCargosApiV1CargoGeneralGetError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/general/'
    });
};
...
/**
 * Create New Cargo Accountant
 */
export const createNewCargoAccountantApiV1CargoAccountantPost = <ThrowOnError extends boolean = false>(options: Options<CreateNewCargoAccountantApiV1CargoAccountantPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateNewCargoAccountantApiV1CargoAccountantPostResponse, CreateNewCargoAccountantApiV1CargoAccountantPostError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/accountant/'
    });
};
...
/**
 * Delete Existing Cargo Accountant
 */
export const deleteExistingCargoAccountantApiV1CargoAccountantCargoIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteExistingCargoAccountantApiV1CargoAccountantCargoIdDeleteData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteExistingCargoAccountantApiV1CargoAccountantCargoIdDeleteResponse, DeleteExistingCargoAccountantApiV1CargoAccountantCargoIdDeleteError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/accountant/{cargo_id}/'
    });
};
