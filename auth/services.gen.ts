 ...
 * Signin User
 */
export const signinUserApiV1AuthRefreshTokenPost = <ThrowOnError extends boolean = false>(options: Options<SigninUserApiV1AuthRefreshTokenPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<SigninUserApiV1AuthRefreshTokenPostResponse, SigninUserApiV1AuthRefreshTokenPostError, ThrowOnError>({
        ...options,
 ...
 * Get Brokers
 */
export const getBrokersApiV1AuthChangePasswordGet = <ThrowOnError extends boolean = false>(options: Options<GetBrokersApiV1AuthChangePasswordGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetBrokersApiV1AuthChangePasswordGetResponse, GetBrokersApiV1AuthChangePasswordGetError, ThrowOnError>({
        ...options,
 ...
 */
export const adminChangePasswordApiV1UsersUserIdChangePasswordPost = <ThrowOnError extends boolean = false>(options: Options<AdminChangePasswordApiV1UsersUserIdChangePasswordPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<AdminChangePasswordApiV1UsersUserIdChangePasswordPostResponse, AdminChangePasswordApiV1UsersUserIdChangePasswordPostError, ThrowOnError>({
        ...options,
