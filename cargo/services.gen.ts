 ...
 */
export const getCargoStatusHistoryApiV1CargoAdminStatusHistoryCargoIdGet = <ThrowOnError extends boolean = false>(options: Options<GetCargoStatusHistoryApiV1CargoAdminStatusHistoryCargoIdGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetCargoStatusHistoryApiV1CargoAdminStatusHistoryCargoIdGetResponse, GetCargoStatusHistoryApiV1CargoAdminStatusHistoryCargoIdGetError, ThrowOnError>({
        ...options,
        url: '/api/v1/cargo/admin/status-history/{cargo_id}/'
    });
};
